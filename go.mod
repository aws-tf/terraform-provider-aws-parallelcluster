...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudformation v1.56.11
...
replace github.com/aws-tf/terraform-provider-aws-parallelcluster/internal/provider/openapi => ./internal/provider/openapi
