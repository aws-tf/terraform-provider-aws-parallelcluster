...
`make install VERSION=0.0.0-alpha`
...
NOTE: A version is of the form `vX.Y.Z`, if a `-` delimiter exists (ie. `v1.2.3-1`) terraform will consider it a prerelease and will not upgrade to it unless its explicitly defined in the configuration.
